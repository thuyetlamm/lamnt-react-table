...
function TableHeadCustom(_ref) {
  var order = _ref.order,
    ...
    sx = _ref.sx;
  return React__default.createElement(material.TableHead, {
    sx: sx
  }, React__default.createElement(material.TableRow, null, onSelectAllRows && React__default.createElement(material.TableCell, {
    padding: 'checkbox'
  }, React__default.createElement(material.Checkbox, {
    ...
    }, onSort ? React__default.createElement(material.TableSortLabel, {
      hideSortIcon: true,
    ...
    }, headCell.label, orderBy === headCell.id ? React__default.createElement(material.Box, {
...
var RootStyle = styles.styled(material.Box)(function (_ref) {
...
function EmptyContent(_ref2) {
  ...
  }) : null, React__default.createElement(material.Typography, {
    variant: 'h5',
    gutterBottom: true
  }, title), description && React__default.createElement(material.Typography, {
    variant: 'body2',
    sx: {
...
function TableNoData(_ref) {
  ...
  return React__default.createElement(material.TableRow, null, isNotFound ? React__default.createElement(material.TableCell, {
    colSpan: 12
...
function TableSelectedActions(_ref) {
  ...
  return React__default.createElement(material.Stack, Object.assign({
    direction: 'row',
    alignItems: 'center',
    sx: _extends({
      px: 2,
  ...
  }, other), React__default.createElement(material.Checkbox, {
    indeterminate: numSelected > 0 && numSelected < rowCount,
    checked: rowCount > 0 && numSelected === rowCount,
    onChange: function onChange(event) {
      return onSelectAllRows(event.target.checked);
...
function useTable(props) {
  var _useState = React.useState((props === null || props === void 0 ? void 0 : props.defaultDense) || false),
    dense = _useState[0],
    setDense = _useState[1];
  var _useState2 = React.useState((props === null || props === void 0 ? void 0 : props.defaultOrderBy) || 'name'),
    orderBy = _useState2[0],
    setOrderBy = _useState2[1];
  var _useState3 = React.useState((props === null || props === void 0 ? void 0 : props.defaultOrder) || 'asc'),
    order = _useState3[0],
    setOrder = _useState3[1];
  var _useState4 = React.useState((props === null || props === void 0 ? void 0 : props.defaultCurrentPage) || 0),
    page = _useState4[0],
    setPage = _useState4[1];
  var _useState5 = React.useState((props === null || props === void 0 ? void 0 : props.defaultRowsPerPage) || 5),
    rowsPerPage = _useState5[0],
    setRowsPerPage = _useState5[1];
  var _useState6 = React.useState((props === null || props === void 0 ? void 0 : props.defaultSelected) || []),
...
var ReactTableMaterial = function ReactTableMaterial(_ref) {
  ...
  return React.createElement(material.Card, null, React.createElement(material.CardHeader, {
    title: titleTable
  }), React.createElement(material.TableContainer, {
    sx: _extends({
      minWidth: 500,
      position: 'relative'
    }, sxTableContainer)
  }, selected.length > 0 && React.createElement(TableSelectedActions, {
    dense: dense,
    ...
    actions: React.createElement(material.Tooltip, {
      title: 'Delete'
    }, React.createElement(material.IconButton, {
      color: 'primary',
      onClick: function onClick() {}
    }, React.createElement(bs.BsFillTrash2Fill, {
      size: 20
    })))
  }), React.createElement(material.Table, {
    size: dense ? 'small' : 'medium',
    stickyHeader: true
  }, React.createElement(TableHeadCustom, {
    order: order,
    orderBy: orderBy,
    headLabel: columns,
    rowCount: dataTable.length,
  ...
  }), React.createElement(material.TableBody, null, dataTable === null || dataTable === void 0 ? void 0 : dataTable.map(function (row) {
  ...
  }), React.createElement(TableEmptyRows, {
    height: denseHeight,
    emptyRows: emptyRows(page, rowsPerPage, dataTable.length)
  }), React.createElement(TableNoData, {
    title: emptyTitle,
  ...
  }, React.createElement(material.TablePagination, {
...
exports.ReactTableMaterial = ReactTableMaterial;
